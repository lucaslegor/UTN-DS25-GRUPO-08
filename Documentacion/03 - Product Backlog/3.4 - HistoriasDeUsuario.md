...
**Descripción**:  
Como usuario, quiero visualizar el contenido de mi carrito, para revisar lo que voy a comprar.
...
**[HU-007] Realizar una Compra**

**Descripción**:  
Como usuario, quiero poder comprar los productos de mi carrito, para completar el proceso de compra.

**Prioridad**: Must  
**Estimación**: M

**Criterios de Aceptación**:
- El usuario puede elegir método de pago y confirmar la compra.
- El sistema registra la orden y muestra un mensaje de confirmación.

**Riesgos Asociados**:
- **[R05]** Compras no procesadas: Frustración del cliente.
