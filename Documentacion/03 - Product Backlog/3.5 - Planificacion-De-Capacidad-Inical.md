...
| Historia de Usuario | Nombre                      | Estimación | Prioridad | Tareas                                                                | Estimación Tarea |
| :------------------ | :-------------------------- | :--------- | :-------- | :-------------------------------------------------------------------- | :--------------- |
| **HU-010** | **Ver Detalle de Producto** | **15 pts** | **Must** | FE-010-001: Crear la interfaz para mostrar los detalles de un producto seleccionado. | 7 pts            |
|                     |                               |            |           | FE-010-002: Obtener y mostrar los detalles de un producto desde un servicio simulado. | 8 pts            |
...
| **HU-005** | **Ver Carrito de Compras** | **15 pts** | **Must** | FE-005-001: Crear una interfaz básica para mostrar el contenido del carrito de compras. | 8 pts            |
...
| **HU-016** | **Crear Producto** | **15 pts** | **Must** | FE-016-001: Crear un formulario para agregar un nuevo producto (campos básicos). | 7 pts            |
|                     |                               |            |           | FE-016-002: Implementar validaciones de frontend para los campos del formulario. | 5 pts            |
|                     |                               |            |           | FE-016-003: Conectar el formulario con un servicio de creación de productos simulado. | 3 pts            |
...
| Historia de Usuario | Nombre                                  | Estimación | Prioridad | Tareas                                                                     | Estimación Tarea |
| :------------------ | :-------------------------------------- | :--------- | :-------- | :------------------------------------------------------------------------- | :--------------- |
| **HU-017** | **Modificar Producto** | **15 pts** | **Must** | FE-017-001: Crear una interfaz para seleccionar un producto para modificar.         | 5 pts            |
|                     |                                         |            |           | FE-017-002: Mostrar un formulario de edición con los datos del producto seleccionado (simulado). | 7 pts            |
|                     |                                         |            |           | FE-017-003: Conectar el formulario de edición con un servicio de modificación simulado. | 3 pts            |
| **HU-018** | **Eliminar Producto** | **15 pts** | **Must** | FE-018-001: Implementar la funcionalidad para seleccionar y eliminar productos.    | 7 pts            |
|                     |                                         |            |           | FE-018-002: Conectar la funcionalidad de eliminación con un servicio simulado. | 8 pts            |
| **HU-008** | **Ver Historial de Compras** | **15 pts** | **Should**| FE-008-001: Crear una interfaz para listar el historial de compras del usuario. | 7 pts            |
|                     |                                         |            |           | FE-008-002: Obtener y mostrar el historial de compras desde un servicio simulado. | 8 pts            |
| **HU-012** | **Consultar Categoría** | **15 pts** | **Should**| FE-012-001: Mostrar un listado de categorías en la interfaz de administración.    | 7 pts            |
|                     |                                         |            |           | FE-012-002: Obtener el listado de categorías desde un servicio simulado.      | 8 pts            |
| **HU-013** | **Crear Categoría** | **15 pts** | **Must** | FE-013-001: Crear un formulario para agregar una nueva categoría.                 | 8 pts            |
|                     |                                         |            |           | FE-013-002: Conectar el formulario con un servicio de creación de categorías simulado. | 7 pts            |
| **HU-015** | **Eliminar Categoría** | **15 pts** | **Must** | FE-015-001: Implementar la funcionalidad para seleccionar y eliminar categorías. | 7 pts            |
|                     |                                         |            |           | FE-015-002: Conectar la funcionalidad de eliminación con un servicio simulado. | 8 pts            |
