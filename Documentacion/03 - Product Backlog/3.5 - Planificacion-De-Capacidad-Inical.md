...
| Historia de Usuario | Nombre                                  | Estimación | Prioridad | Tareas                                                                     | Estimación Tarea |
| :------------------ | :-------------------------------------- | :--------- | :-------- | :------------------------------------------------------------------------- | :--------------- |
| **HU-013** | **Modificar Producto** | **13 pts** | **Must** | FE-017-001: Crear una interfaz para seleccionar un producto para modificar.         | 5 pts            |
...
| 5     | Gestión de Categorías (CRUD)                          | El administrador puede crear, modificar y eliminar categorías.                                                      |
| 6      | Gestión de Productos (Crear y Consultar), Búsqueda Avanzada | El administrador puede crear y consultar productos. La búsqueda de productos incluye más criterios.           |
| 7      | Gestión de Productos (Modificar y Eliminar)           | El administrador puede modificar y eliminar productos.                                                             |
