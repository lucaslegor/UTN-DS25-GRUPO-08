...
|                     |                               |            |           | FE-021-004: Mostrar un indicador visual de carga mientras se procesa el archivo.| 2 pts            |
...
|                     |                                         |            |           | FE-022-003: Implementar un botón "Confirmar Rechazo" que envíe la solicitud y la razón al servicio correspondiente (simulado). | 5 pts            |
